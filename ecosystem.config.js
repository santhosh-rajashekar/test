module.exports = {
  ...
  deploy : {
    ...
    test : {
      ...
      'post-deploy' : 'npm install; cp /home/lhtdev/secretconfig/ecosystem.config.js ./ecosystem.config.js; sequelize db:migrate --env test; pm2 startOrRestart ecosystem.config.js --update-env --env test'
    },
    demo : {
      user : 'lhtdev',
      host : 'hcm-test-web-host1.westeurope.cloudapp.azure.com',
